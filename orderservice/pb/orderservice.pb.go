...
const file_orderservice_proto_rawDesc = "" +
	"\n" +
	"\x12orderservice.proto\x1a\x0eordermsg.proto2=\n" +
	"\fOrderService\x12-\n" +
	"\n" +
	"PlaceOrder\x12\r.OrderRequest\x1a\x0e.OrderResponse\"\x00B\aZ\x05./;pbb\x06proto3"
...
var file_orderservice_proto_depIdxs = []int32{
	0, // 0: OrderService.PlaceOrder:input_type -> OrderRequest
	1, // 1: OrderService.PlaceOrder:output_type -> OrderResponse
